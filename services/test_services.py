...
class ServiceTests(ServiceBaseTest):
    ...
    def checkLoginSecondPart(self, SERVICE, args, kwargs=None):
        ...
        #print("Kwargs passed to checkLoginSecondPart:", kwargs)
...
# ==== QUESTIONNAIRE ====
    ...
    def test06_questionnaireCreate(self):
        ...
        kwargs = {'title': 'newTitle'}
        print("All questionnaires before:", list(Questionnaire.objects.all()))  # Add this line to print all questionnaires
        ...
        print("Logged-in user:", self.client.session['_auth_user_id'])
        ...
        print("Response content after questionnaire creation:", self.decode(response.content))
        ...
        print("All questionnaires:", list(Questionnaire.objects.all()))  # Add this line to print all questionnaires
        print("Retrieved questionnaire:", questionnaire)
...
# ==== GAME ====
    def test36_gameCreate(self):
        ...
        if(game == None): print("TYPE IS NONE")
